...
<table id="cart" class="table table-hover table-condensed">
        ...
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                <tr data-id="{{$id}}">
                    <td data-th="Hotel">
                        <div class="row">
                            <div class="col-sm-3 hidden-xs"><img src="{{ asset('/images')}}/{{ $details['image'] }}" width="200" height="150" class="img-responsive"/></div>
                            <div class="col-sm-9">
                                <p class="nomargin" style="color:black;margin-left:100px;">{{ $details['name'] }}</p>
                            </div>
                        </div>
                    </td>
                    <td data-th="Price">RM {{ $details['price'] }}</td>
                    <td data-th="Quantity">
                        <input type="number" readonly value="{{ $details['quantity'] }}" class="form-control quantity update-cart" />
                    </td>
    ...
    <tfoot>
        <tr>
            <td colspan="5" class="text-right" ><h3><strong style="color:black;">Total RM{{ $total }}</strong></h3></td>
        </tr>
        <tr>
            <td colspan="5" class="text-right">
                <a href="{{ url('/showHotel') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a>
