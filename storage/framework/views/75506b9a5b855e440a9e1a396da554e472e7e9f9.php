...
<div class="row">
    ...
    <div class="col-sm-8">
        <form action="<?php echo e(route('addHotel')); ?>" method="post" enctype="multipart/form-data"><br><br>
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\f\resources\views/addHotel.blade.php ENDPATH**/ ?>